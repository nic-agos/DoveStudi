	...
	<div class= "container head-profile">
		...
		<div class="row" id="tab">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item">
                    	<a class="nav-link" id="home-tab" data-toggle="tab" href="AccountPersonalInfo.jsp" role="tab" aria-controls="home" aria-selected="false">About</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      	<a class="nav-link active" id="reviews-tab" data-toggle="tab" href="AccountMyReviews.jsp" role="tab" aria-controls="groups" aria-selected="true">My Reviews</a>
                    </li>
				</ul>
		</div>
		
		<div class="col-md-18" style="margin-top:50px;" >
		<div class="row">
