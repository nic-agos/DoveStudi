...
<%
	...
	if(request.getParameter("searchBtn") != null){
		...
		try{
			...
			allRoomsList = rContr.searchRoomByDate(roomSpecBean);
...
<body>
	<div id="sidebar">
		<div id="rectangle" >
			<div class="toggle-btn" onclick="toggleSideBar(); togglePage();">
				<span></span>
				<span></span>
				<span></span>
			</div>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-left:230px;">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    	<ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        	...
		        	<li class="nav-item">
		          		<a class="nav-link active" aria-current="page" href="SearchRoomsDate.jsp">Date</a>
		        	</li>
		        	<li class="nav-item">
		      	...
		      	<form class="d-flex">
		        	<input class="form-control me-2" type="search" placeholder="YYYY/MM/DD" id="date" name="date" aria-label="Search">
